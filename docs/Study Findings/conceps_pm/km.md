...
A portion of these findings were specifically tied to the characteristics of the various platforms used in the project.  

**One contributor said that** *“We try to avoid long pieces of feedback in chats like the Matrix rooms, because we'd like it to be archived somewhere for future references.”* (Interview, Jellyfin).  
{: .fs-5 .fw-300 }

The idea of information being lost in Matrix is confirmed in that Matrix is not always as easy to search through as for instance Github.  
...
## Summary
<br/>
* It is in all FLOSS projects best interest to make design processes 'visible' to as many people as possible.
* While the value of chat platforms are high, there are some concerns in terms of loosing the rationale of why decisions was made, as information is quickly buried under new information
* GitHub Discussions would appear to be a new place that can facilitate these types of discussions, and allow for more visually rich discussions to take place.